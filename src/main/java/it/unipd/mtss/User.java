...
public class User {
    ...
    public User(String _id, String _name, String _surname, LocalDate _birthDate) throws IllegalArgumentException, NullPointerException{
        ...
        }else throw new NullPointerException("Invalid id reference (null)");
        ...
        }else throw new NullPointerException("Invalid name reference (null)");
        ...
        }else throw new NullPointerException("Invalid surname reference (null)");
